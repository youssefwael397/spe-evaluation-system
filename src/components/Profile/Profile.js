    ...
    <div className="container-xl mx-auto ">
      <div className="Profile my-4 rounded bg-white p-4 position-relative w-100">
        ...
        <div className="row my-3">
          {
            tasks.length > 0 && type ? (<h5 className="my-3 text-primary">{tasks.length} {type === 'm' ? "meetings" : type === 't' ? 'tasks' : 'tasks and meetings'}</h5>) : type ? <h5 className="my-3 text-primary text-center">There is no {type === 'm' ? "meetings" : type === 't' ? 'tasks' : 'tasks or meetings'}</h5> : null
          }
