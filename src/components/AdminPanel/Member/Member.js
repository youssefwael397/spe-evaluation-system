            ...
            fetch(`${API_PATH}/committees/${userInfo.first_com_id}`)
                ...
                .then(data => {
                    if (data.status === 'ok') {
                        ...
                        console.log("error to set first com")
                    }
                })
        }
            ...
            fetch(`${API_PATH}/committees/${userInfo.first_com_id}`)
                ...
                .then(data => {
                    if (data.status === 'ok') {
                        ...
                        console.log("error to set second com")
                    }
                })
        } else if (userInfo.second_com_id !== user.first_com_id && userInfo.second_com_id !== null) {
            fetch(`${API_PATH}/committees/${userInfo.second_com_id}`)
                ...
                <div className="task-options my-2 mx-2">
                    <form onSubmit={(e) => getTasks(e)} >
                        <div className="row my-2">
                            <FormControl className="col-4 px-1">
                            ...
                            <div className=" row col-6 d-flex align-items-center">
                                <input className="col-2 px-3 mx-auto form-check-input" type="checkbox" id="checkboxNoLabel" checked={isChecked} onChange={(e) => setIsChecked(e.target.checked)} aria-label="..." />
                                <FormControl className="col-10 px-1">
